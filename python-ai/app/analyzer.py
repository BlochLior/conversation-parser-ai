...
prompt = PromptTemplate(
    ...
    template="""
You are a communication skills coach. Analyze the following conversation.
Identify any communication issue or misunderstandings, and suggest improvements.
Conversation:
{conversation}
...
async def analyze_conversation(text: str) -> AnalyzeResponse:
